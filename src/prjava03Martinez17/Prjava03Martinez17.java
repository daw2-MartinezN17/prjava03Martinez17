...
package prjava03Martinez17; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
import java.io.*;
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava03Martinez17 extends Frame 
   ...
   public Prjava03Martinez17 () { 
      ...
      setTitle("nova finestra prjava03Martinez17");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava03Martinez17();  // Let the construct do the job 
   } 
